...
// script for S3 login with facebook ID
function s3upload () {
	var appId = '1022234894516729';

	        var roleArn = 'pixelart-dev1';

	        var bucketName = 'pixelart-blender-01/input';

	        AWS.config.region = 'eu-west-1c';
